...
| `case_insensitive` | `true`                               | `false`  | Automatically apply case insensitivity to triggers.                                 |
| `enterprise`       | `false`                              | `false`  | Use GitHub Enterprise client which leverages `GITHUB_API_URL` environment variable. |
